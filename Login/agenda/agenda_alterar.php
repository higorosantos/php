      ...
      <div class="jumbotron" style ='font-size:16px'>
		<?php 
                ...
                if(isset($_POST["alterar"])){
                    ...
                    $evento = $_POST["evento"];
                    $local = $_POST["local"];
                    $query = mysqli_query($conect,"UPDATE agenda SET data='$data' ,hora='$hora',evento='$evento',local='$local' WHERE data = '$data'") or die(mysql_error());
                        ...
                        $data = $_POST["data1"];
          	            $hora = $_POST["hora1"];
							...
							if($result == 0){
                                ...
                                <input type="text" name="evento" id="evento" class="form-control" style ='width:150px;text-align:center'  value="<?php echo $evento;?>" /></br>
                                <label for="inputEvento" >Local</label>
								<input type="text" name="local" id="local" class="form-control" style ='width:150px;text-align:center' value="<?php echo $local;?>"  /></br>                                
                                <button  type="submit" name="alterar" id="alterar" style ='width:200px'/>Alterar</button>							
